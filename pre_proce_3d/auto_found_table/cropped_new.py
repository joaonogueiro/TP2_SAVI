...
def main():
    ...
    plane_model, inlier_idx = pcd_cropped.segment_plane(distance_threshold=0.03,
                                         ransac_n=3,
                                         num_iterations=100)
    ...
    labels = pcd_objects.cluster_dbscan(eps=0.055, min_points=50, print_progress=True)
    ...
    pcds_to_draw = [pcd_table, pcd_cap_downsampled]
