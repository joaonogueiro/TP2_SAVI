...
view = {
	...
	[
		{
			"boundingbox_max" : [ 3.0000000000000004, 3.0000000000000004, 3.6111083030700684 ],
			"boundingbox_min" : [ -2.919234037399292, -2.1469309329986572, -1.5795096158981323 ],
			"field_of_view" : 45.0,
			"front" : [ -0.66152213133433768, -0.030723914672344192, -0.74929601014691249 ],
			"lookat" : [ 0.040382981300354226, 0.42653453350067161, 1.015799343585968 ],
			"up" : [ 0.2135605390898557, -0.96550738741513864, -0.1489542916147219 ],
...
def main():
    ...
    point_cloud_filename = dataset_path + '/10.ply'
